  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'neu-light-pressed': '4px 4px 8px #d1d9e6, -4px -4px 8px #ffffff, inset 2px 2px 4px #d1d9e6, inset -2px -2px 4px #ffffff',
        'neu-dark': '8px 8px 16px rgba(0, 0, 0, 0.3), -8px -8px 16px rgba(255, 255, 255, 0.05)',
        'neu-dark-pressed': '4px 4px 8px rgba(0, 0, 0, 0.3), -4px -4px 8px rgba(255, 255, 255, 0.05), inset 2px 2px 4px rgba(0, 0, 0, 0.3), inset -2px -2px 4px rgba(255, 255, 255, 0.05)',
        'glass': '0 8px 32px rgba(0, 0, 0, 0.1)',
        'glass-dark': '0 8px 32px rgba(0, 0, 0, 0.3)',
        'focus-ring': '0 0 0 3px rgba(99, 102, 241, 0.4)',
        'hover-float': '0 10px 25px -5px rgba(0, 0, 0, 0.1), 0 8px 10px -6px rgba(0, 0, 0, 0.1)'
      },
      borderRadius: {
        'xl': '0.75rem',
        '2xl': '1rem',
